                ...
                <div class="card-body">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-group" method="post">
                            ...
                            <label for="" class="my-2"><i class="feather-user text-primary"></i>User Name</label>
                            ...
                            <label for="" class="my-2"><i class="feather-lock text-primary"></i>Comfirm Password</label>
                            <input type="password" name="cpass" id="" class="form-control" min="8" required>
                        </div>
                        <div class="form-group mb-0">
                            <button class="btn btn-primary" name="reg-btn">Register</button>
                           <a href="login.php" class="btn btn-outline-primary">Sign In</a> <!-- btn-line-link-->
                        </div>
                    </form>
                </div>
            </div>
